...
namespace PhotoBookmart.Web.abScripting
{
    ...
    public class wwScripting
	{
		...
		/// </summary>
		public string cAssemblyNamespace = "abScriptingDLRSandbox";

		/// <summary>
		/// Name of the class created by the script processor. Script code becomes methods in the class.
		/// </summary>
		public string cClassName = "abScriptingSingleClass";
		...
		public object ExecuteMethod(string lcCode, string lcMethodName, params object[] loParameters) 
		{
			...
			if (this.oObjRef == null) 
			{
				if (this.lFirstLoad)
				{
                    ...
                    this.AddAssembly(this.cSupportAssemblyPath + "ABCMS.abScripting.dll", "ABCMS.abScripting");
        ...
        public object NetValidation(string lcCode, params object[] loParameters)
        {
            if (this.cScriptingLanguage == "CSharp")
                return this.ExecuteMethod("public bool NetValidation(params object[] Parameters) {" +
                        lcCode +
                        "}",
                        "NetValidation", loParameters);
            else if (this.cScriptingLanguage == "VB")
                return this.ExecuteMethod("public function NetValidation(ParamArray Parameters() As Object) as boolean\r\n" +
                    lcCode +
                    "\r\nend function\r\n",
                    "NetValidation", loParameters);
        ...
        public object NetDefaultValue(string lcCode)
        {
            if (this.cScriptingLanguage == "CSharp")
                return this.ExecuteMethod("public object NetDefaultValue() {" +
                        lcCode +
                        "}",
                        "NetDefaultValue");
            else if (this.cScriptingLanguage == "VB")
                return this.ExecuteMethod("public function NetDefaultValue() as object\r\n" +
                    lcCode +
                    "\r\nend function\r\n",
                    "NetDefaultValue");
		...
		public object CreateInstance() 
		{
			...
			try 
			{
				...
				else 
				{
                    ...
                    RemoteLoaderFactory factory = (RemoteLoaderFactory)this.oAppDomain.CreateInstance("RemoteLoader", "ABCMS.abScripting.RemoteLoaderFactory").Unwrap();
