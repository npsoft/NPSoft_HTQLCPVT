...
{
    // sample https://github.com/ServiceStack/ServiceStack/blob/9db6f99273f59c3ac1d359d445cea3d95f701985/src/ServiceStack.Server/Caching/OrmLiteCacheClient.cs

    public class OrmLiteCacheClient
        : ICacheClient, IRemoveByPattern
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(OrmLiteCacheClient));
