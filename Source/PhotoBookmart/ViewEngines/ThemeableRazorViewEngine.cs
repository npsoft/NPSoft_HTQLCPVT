...
namespace PhotoBookmart
{
    public class ThemeableRazorViewEngine : ThemeableBuildManagerViewEngine
    {
        public ThemeableRazorViewEngine()
        {
            ...
            ViewLocationFormats = new[] {
                                            ...
                                            "~/Themes/{2}/Views/{1}/{0}.vbhtml",
                                             "~/Themes/{2}/Views/Common/{0}.cshtml",
                                            "~/Themes/{2}/Views/Common/{0}.vbhtml",
        ...
        {
            return new ThemableRazorView(controllerContext, partialPath, null, false, ViewStartFileExtensions);
        }

        protected override IView CreateView(ControllerContext controllerContext, string viewPath, string masterPath)
        {
            return new ThemableRazorView(controllerContext, viewPath, masterPath, true, ViewStartFileExtensions);
        }
